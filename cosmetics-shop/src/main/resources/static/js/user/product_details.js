...
const productId = relatedProductsSeperate.getAttribute("data-id");
		...
		<div id="related-product" class="col-md-3 mb-4">
				<div class="card position-relative">
						...
						<div class="card-body">
							...
							<p class="card-text fst-italic lead text-nowrap" style="overflow: hidden;text-overflow: ellipsis;" >
								${product.description}
							</p>
